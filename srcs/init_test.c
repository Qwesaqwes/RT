...
t_list 	*init_test(void)
{
	...
	obj5.id = 4;
	obj5.transform.scale.x = 100;
	obj5.transform.scale.y = 100;
	obj5.transform.scale.z = 100;
	obj5.transform.scale.w = 1;
	obj5.type = 2;
	obj5.transform.transl.x = 2000;
	...
	obj6.id = 5;
	obj6.transform.scale.x = 100;
	obj6.transform.scale.y = 100;
	obj6.transform.scale.z = 100;
	obj6.transform.scale.w = 1;
	obj6.type = 2;
	obj6.transform.transl.x = 0;
	obj6.transform.transl.y = 0;
	obj6.transform.transl.z = 3000;
	obj6.transform.transl.w = 1;
	obj6.transform.rot.x = 0;
	obj6.transform.rot.y = 50;
